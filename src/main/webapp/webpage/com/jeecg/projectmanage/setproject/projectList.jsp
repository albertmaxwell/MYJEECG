	...
	<div id="projectList" v-cloak>
		...
		<el-row>
			<el-form :inline="true" :model="filters" size="mini" ref="filters">
				...
				<el-form-item style="margin-bottom: 8px;" prop="head">
					<el-input v-model="filters.head" auto-complete="off" placeholder="请输入负责人"></el-input>
				</el-form-item>
				...
				<el-form-item style="margin-bottom: 8px;" prop="note">
					<el-input type="textarea" v-model="filters.note"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="projects" border stripe highlight-current-row size="mini" v-loading="listLoading" @sort-change="handleSortChange" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="background" label="项目背景" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="head" label="负责人" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="customerCode" label="项目客户编号" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="note" label="备注" min-width="120" sortable="custom" show-overflow-tooltip></el-table-column>
